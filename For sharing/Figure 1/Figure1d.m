%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Figure 1d -- Overlay of delay epoch uninstructed movement trajectories
% onto still image from video
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear,clc,close all
...
% nose
feat1x = obj.traj{view}(trial).ts(:,1,3); 
feat1y = obj.traj{view}(trial).ts(:,2,3); 
