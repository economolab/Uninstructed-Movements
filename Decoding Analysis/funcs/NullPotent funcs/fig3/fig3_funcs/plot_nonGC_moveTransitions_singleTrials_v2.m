function plot_nonGC_moveTransitions_singleTrials_v2(dat,obj,me,rez,params,dim,meta)
...
for sessix = 1:numel(me)
    ...
    for trix = 1:nTrials
        ...
        for i = 1:size(mdat_trix,2)
            if rand > 0.3 % plot half of the transitions
                continue
            end
...
%             patchline(ts,potentplot,'EdgeColor','g','EdgeAlpha',0.35)
    ...
    xlabel('seconds (Move to quiet transitions)')
