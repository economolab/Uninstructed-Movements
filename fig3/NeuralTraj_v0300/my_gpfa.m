...
anm_date_prb{1} = {'JEB7','2021-04-29',1};
anm_date_prb{end+1} = {'JEB7','2021-04-30',1};
anm_date_prb{end+1} = {'JEB6','2021-04-18',2};
anm_date_prb{end+1} = {'JGR2','2021-11-16',1};
anm_date_prb{end+1} = {'JGR2','2021-11-17',1};
anm_date_prb{end+1} = {'JGR3','2021-11-18',1};
anm_date_prb{end+1} = {'EKH3','2021-08-11',2};
anm_date_prb{end+1} = {'EKH1','2021-08-07',2};

for adpix = 1:numel(anm_date_prb)

    clearvars -except adpix anm_date_prb
    ...
    params.probe(1) = anm_date_prb{adpix}{3};
    ...
    meta.datapth = 'C:\Users\munib\Documents\Economo-Lab\data\';
    meta.anm = anm_date_prb{adpix}{1}; % 'JEB7'  'EKH3'
    meta.date = anm_date_prb{adpix}{2}; % '2021-04-29'   '2021-08-11
    ...
    gpparams.xDim      = [15];             % Select number of latent dimensions
    % JEB7 4-29 best xDim = 10
    gpparams.binWidth  = params.dt * 1000;             % spike bin width in ms
    gpparams.numFolds  = 0;              % cross validation folds to find best xDim
    gpparams.kernSD = 100;

    % if runIdx exists delete it
    try
        rmdir('mat_results\run004\','s')
    catch
    end
    ...
    [estParams, seqTrain] = postprocess(result,'kernSD',gpparams.kernSD);
    ...
    for i = 1:numel(seqTrain)
        gpfalatents(:,:,i) = seqTrain(i).xorth';
    end

    % % save data
    savepth = 'C:\Users\munib\Documents\Economo-Lab\data\gpfa';
...
plotPredErrorVsDim(gpparams.runIdx, gpparams.kernSD);
