...
for gg = 1:length(meta)         % For all loaded sessions...
    ...
    % Plot jaw velocity heatmap only for trials from specific conditions
    subplot(3,2,5)
    JawVelHeatmap(conditions,jaw_by_cond,taxis)
...
%     subplot(3,2,6)
%     ActivityMode_Jaw_Scatter(jawVel_late,Choice_late,conditions,met,clrs,obj,params);
%     
