...
for gg = 1:length(meta)         % For all loaded sessions...
    ...
    removehalf = 'no';
    [obj,met] = removeTrials(met,obj,removehalf);
    ...
    conditions = 1:2;
    [mode,dat,proj,kinfns] = calcKinModes(kin,obj,params,psthForProj,conditions,taxis);  % Time-points used to find modes are specified in the function
...
%% FUNCTIONS
function [obj,met] = removeTrials(met,obj,removehalf) 
