...
% fn = ['null_' rates_or_factors '_JEB7_2021-04-29_lfadsrun3'];
% mysavefig(f,pth,fn);
% 
% f = figure(21);
% pth = '/Users/Munib/Documents/Economo-Lab/code/uninstructedMovements/fig4/figs/pcaNullSpace/';
% fn = ['potent_' rates_or_factors '_JEB7_2021-04-29_lfadsrun3'];
% mysavefig(f,pth,fn);
...
% f = figure(211);
% pth = '/Users/Munib/Documents/Economo-Lab/code/uninstructedMovements/fig4/figs/pcaNullSpace/';
% fn = ['nullCDs_' rates_or_factors '_JEB7_2021-04-29_lfadsrun3'];
% mysavefig(f,pth,fn);
% 
% f = figure(212);
% pth = '/Users/Munib/Documents/Economo-Lab/code/uninstructedMovements/fig4/figs/pcaNullSpace/';
% fn = ['potentCDs_' rates_or_factors '_JEB7_2021-04-29_lfadsrun3'];
% mysavefig(f,pth,fn);
