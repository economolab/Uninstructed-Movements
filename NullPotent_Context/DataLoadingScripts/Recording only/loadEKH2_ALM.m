function meta = loadEKH2_ALM(meta)
meta(end+1).datapth = fullfile('C:\Users\Jackie\Documents\Grad School\Economo Lab\DataObjects\EKH2');
meta(end).anm = 'EKH2';
meta(end).date = '2021-07-16';
...
meta(end+1) = meta(end);
meta(end).datapth = fullfile('C:\Users\Jackie\Documents\Grad School\Economo Lab\DataObjects\EKH2');
meta(end).anm = 'EKH2';
