function meta = loadEKH3_ALM(meta)
meta(end+1).datapth = fullfile('C:\Users\Jackie\Documents\Grad School\Economo Lab\DataObjects\EKH3');
meta(end).anm = 'EKH3';
...
meta(end+1) = meta(end);
meta(end).datapth = fullfile('C:\Users\Jackie\Documents\Grad School\Economo Lab\DataObjects\EKH3');
meta(end).anm = 'EKH3';
