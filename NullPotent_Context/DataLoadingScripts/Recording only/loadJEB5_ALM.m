function meta = loadJEB5_ALM(meta)
meta(end+1).datapth = fullfile('C:\Users\Jackie\Documents\Grad School\Economo Lab\DataObjects\JEB5');
meta(end).anm = 'JEB5';
...
meta(end+1) = meta(end);
meta(end).datapth = 'C:\Users\Jackie\Documents\Grad School\Economo Lab\DataObjects\JEB5';
meta(end).anm = 'JEB5';
meta(end).date = '2021-02-26';
meta(end).datafn = findDataFn(meta(end));
meta(end).probe = 2;
