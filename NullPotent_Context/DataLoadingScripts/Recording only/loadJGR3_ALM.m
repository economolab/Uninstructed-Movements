function meta = loadJGR3_ALM(meta)
meta(end+1).datapth = fullfile('C:\Users\Jackie\Documents\Grad School\Economo Lab\DataObjects\JGR3');
meta(end).anm = 'JGR3';
...
meta(end+1) = meta(end);
meta(end).datapth = fullfile('C:\Users\Jackie\Documents\Grad School\Economo Lab\DataObjects\JGR3');
meta(end).anm = 'JGR3';
