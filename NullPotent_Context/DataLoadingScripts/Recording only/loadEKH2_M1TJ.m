function meta = loadEKH2_M1TJ(meta)
meta(end+1).datapth = fullfile('D:\JEB\DataObjects\EKH2');
meta(end).anm = 'EKH2';
...
meta(end+1) = meta(end);
meta(end).datapth = fullfile('D:\JEB\DataObjects\EKH2');
meta(end).anm = 'EKH2';
meta(end).date = '2021-07-17';
meta(end).datafn = findDataFn(meta(end));
meta(end).probe = 1;
