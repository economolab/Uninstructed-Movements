function plotAvgJawVelocityDuringStim_firstHalfDelay(meta,obj,dfparams,params,kin,kinfeats,feats2plot,cond2plot,sav)
...
times = [0 0.2]; % relative to alignEv (should be delay)
for i = 1:numel(times)
