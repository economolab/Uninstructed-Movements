...
function moveprob = moveProbSessionAvg(met,conditions,mov,me)
...
for i = 1:numel(conditions)
    ...
    for ii = 1:length(trialsToUse)
        ...
        ts = me.data.data{q};                                            % Motion energy values for this trial
    ...
    movedat = medfilt1(movedat,10);           % Smooth the avg probability of jaw movement 
