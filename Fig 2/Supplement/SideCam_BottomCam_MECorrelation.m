...
load('C:\Users\Jackie\Documents\Grad School\Economo Lab\Code\Uninstructed-Movements\Fig 2\Hazarded Delay\BehavData\JEB11_JEB12_objs.mat');
load('C:\Users\Jackie\Documents\Grad School\Economo Lab\Code\Uninstructed-Movements\Fig 2\Hazarded Delay\BehavData\JEB11_JEB12_meta.mat');
load('C:\Users\Jackie\Documents\Grad School\Economo Lab\Code\Uninstructed-Movements\Fig 2\Hazarded Delay\BehavData\JEB11_JEB12_params.mat');
...
for sessix = 1:length(meta)
    ...
    if size(sideme(sessix).data,2)==size(bottomme(sessix).data,2)
        ...
        for trix = 1:nTrials
            side = mySmooth(sideme(sessix).data(:,trix),21);
            bottom = mySmooth(bottomme(sessix).data(:,trix),21);
