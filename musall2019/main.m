...
moveLabels = [moveLabels, {'iME_Cam0'}, {'uiME_Cam0'}, {'iME_Cam1'}, {'uiME_Cam1'},  {'iVideo_Cam0'}, {'uiVideo_Cam0'},  {'iVideo_Cam1'}, {'uiVideo_Cam1'}];
...
temp{1} = squeeze(mean(dat(:,trials.right,:),2));
temp{2} = squeeze(mean(dat(:,trials.left,:),2));
